...
public class SentenceSorterTest {
    ...
    public void processSentence() throws Exception {
        String actual = "Bye. It is a 1200.0 established fact that a reader will be of a page when looking at its layout." +
                " It has survived not only five centuries, but also the leap into 13.141120008059866 electronic -1.0 typesetting," +
                " remaining 8.0 essentially -3.0 unchanged. It is a long established fact that a reader will be distracted by the" +
                " readable content of a page when looking at its layout. The point of usg -0.2549327819483933 Ipsum is that it has" +
                " a more-or-less normal distribution of letters, as opposed to usg 'Content here, content here', making it look like" +
                " readable English. It was popularised in the -96.0 with the release of Letraset sheets containing Lorem Ipsum" +
                " passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. \n";
        SentenceSorter sentenceSorter = new SentenceSorter();
        sentenceSorter.handle(compositeText);
        Assert.assertEquals("Sentence counting failed.", sentenceSorter.getResult().toString(), actual);
    }
